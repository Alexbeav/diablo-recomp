...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/diablo-recomp/total)](https://github.com/Alexbeav/diablo-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/diablo-recomp/latest/total)](https://github.com/Alexbeav/diablo-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/diablo-recomp)](https://github.com/Alexbeav/diablo-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Diablo** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

Diablo recompiled for modern systems using psxrecomp.

| | |
|---|---|
| Players | 2 |
| Region | Europe |
| Publisher | Electronic Arts / Blizzard Entertainment |
| Year | 1998 |
...
Zip prefix for CI artifacts: `diablo-recomp`.
